...
const float GAIN_BATTERY = 0.02471; // 3.3V/1024 * 230(RESISTOR1+2) / 30(RESISTOR1)
...
const float LOADCELL_CURRENT_DEADZONE = 0.3;
...
#define POLE_PAIR 15
#define W_RADIUS 0.0825
#define g 9.81
const float DIST_WHEELS = 0.684; //2*D
