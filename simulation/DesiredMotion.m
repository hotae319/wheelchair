function desired_acc = DesiredMotion(torque, wheel_speed)

M_BODY = 61;M_WHEEL = 8; gravity =9.81; theta = 0*pi/180;
RADIUS_WHEEL = 0.127; DIST_WHEELS = 0.342; I_WHEEL = 0.03; I_BODY = 5.16;
Rk = [0.5 0; 0 0.5]; % resistance speed
